...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, udmDataBase, udmFormUtils, cxGraphics,
...
type
  TfmGrid = class(TForm)
    ...
    FDQuery1: TFDQuery;
    FDQuery1ID: TLargeintField;
    FDQuery1CAPTION: TWideStringField;
...
procedure TfmGrid.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;
